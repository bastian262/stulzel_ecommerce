...
const Stands = () => {
    ...
    const redireccionarWhatsApp = () => {
        const url = "https://wa.me/56934240942";
            ...
            <div class="contenedorCollapse" id="stands" style={{maxHeight: "0px"}}>
                <div class="contenedor">
                    <div class="stands">
                        <div class="headerStand">
                            ...
                            <p>Salón look más que una feria, es una excelente plataforma para generar relaciones comerciales firmes en el tiempo, y hoy más que nunca, necesitamos de la colaboración continua entre empresas del sector de la belleza y la estética.</p>
                            ...
                            <div class="btnWhats" onClick={() => redireccionarWhatsApp()}>
                                <WhatsAppIcon className="icon" />
                                <div>
                                    <span>INSCRÍBETE LLAMANDO A ESTE WHATSAPP</span>
                                    <p>
                                        +569 <strong>3424 0942</strong> 
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="gris">
                    <div class="contenedor">
                        ...
                        <div class="btnverde">
                            <p>Ejemplo stand 6m2: <br/> <strong>6,5 X $30.048,36 = $195.312 X 6(m2) = $1.171.872 + IVA.</strong> <br /> <strong>(UF al 20 de Sept.)</strong></p> 
                        </div>
                    </div>
                </div>
                <div class="verde">
                    <div class="contenedor">
                        ...
                        <div onClick={() => redireccionarWhatsApp()}>
                            <WhatsAppIcon className="icon" /> <span>+569 <strong> 3424 0942</strong></span>
                        </div>
                    </div>
                </div>
                <div class="contenedor">
                    <h2>¿Si compro un Stand con más metros cuadrados tendré mejores valores? </h2>
                    <span>Eventualmente y por motivos de la alta demanda en la venta de los Stand no existen precios diferenciados autorizados, pero dada la 
                        gencia, y por motivos del contante apoyo al rubro podemos evaluar descuentos por la toma de espacio de mayores superficies.</span>
                </div>
                <div class="gris">
                    <div class="contenedor">
                        <h2>
                            Cuándo adquiero un Stand, ¿qué me entregan para el uso del mismo?
                        </h2>
                ...
                <div class="contenedor">
                    ...
                    <div class="row">
                        ...
                        <div class="colu1">
                            ...
                            <p>• Representantes de spa, hoteles y resorts.</p>
                            <p>• Compañías farmacéuticas, laboratorios.</p>
                            <p>• Organizaciones de belleza, estética y barbería.</p>
                            <p>• Emprendedores.</p>
                            <p>• Laboratorios.</p>
                            <p>• Empresas proveedoras de mobiliarios y materia prima.</p>
                            <p>• Diseño de vestuario.</p>
                            <p>• Académicos de escuelas e institutos de formación.</p>
                            <p>• Medios de comunicación tradicional y especializados</p>
                        </div>
                    </div>
                </div>
            </div>
