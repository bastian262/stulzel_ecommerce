                ...
                <Spin spinning={loading} size="large" tip="Cargando..." indicator={antIcon}>
                    <div className="contenedorStreaming">
                        <div className="streaming">
                            <iframe title="streaming" src="https://player.twitch.tv/?channel=stulzel&parent=https://stulzel-ecommerce.vercel.app/webinar" parent="https://stulzel-ecommerce.vercel.app/webinar" frameBorder="0" allowFullScreen="true" scrolling="no"></iframe>
                        </div>
